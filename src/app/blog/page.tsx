	...
	return (
		<section className="flex flex-col gap-6 lg:pl-3">
			<div className="flex flex-col gap-1">
				<h1 className="group relative inline-flex w-fit self-start px-3 py-1 lg:px-4 lg:py-2 -rotate-1 font-caveat mb-4 text-4xl lg:text-5xl font-semibold tracking-wide transition-transform duration-300 ease-in-out hover:translate-x-1 hover:translate-y-1 dark:text-white">
				...
				{blogs.length === 0 ? (
					<p className="mt-4 font-sans text-lg opacity-75 dark:text-white/70 dark:opacity-100">No blogs yet.</p>
				) : (
