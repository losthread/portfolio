...
export default function ProjectPreview({ imagePath, imageAlt, projectUrl, className })
{
      ...
      >
        ...
        >
          ...
          <img 
            src={imagePath}
            alt={imageAlt}
            className={`absolute inset-0 w-full h-full object-cover transition-all duration-500 ${isHovered ? 'opacity-80 scale-102' : 'opacity-40'}`}
          />
